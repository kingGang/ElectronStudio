...
var emotionKeywords = []struct {
	...
	{"lol", []string{"哈哈大笑", "笑疯", "笑到不行", "笑得不行", "狂笑", "笑喷", "笑抽", "大笑", "🤣"}},
	{"laughing", []string{"哈哈哈", "笑死", "太好笑", "笑死我", "哈哈哈哈", "笑不活", "😆"}},
	{"crying", []string{"哭了", "呜呜呜", "泪目", "想哭", "泪奔", "哭死", "😭"}},
	{"naughty", []string{"色色", "涩涩", "好色", "坏笑", "嘿嘿嘿", "不正经", "想什么呢", "😏", "🤤"}},
	{"loving", []string{"爱你", "喜欢你", "么么", "抱抱", "亲亲", "最爱", "宝贝", "心动", "😍", "🥰", "❤"}},
	{"embarrassed", []string{"尴尬", "不好意思", "害羞", "脸红", "羞羞", "囧", "😳", "😅"}},
	{"scared", []string{"害怕", "好怕", "吓人", "恐怖", "瑟瑟发抖", "怕了", "😨", "😰"}},
	{"shocked", []string{"震惊", "吓死", "吓我", "天啊", "我勒个", "卧槽", "太可怕", "😱"}},
	{"thinking", []string{"让我想想", "思考", "想一想", "嗯……", "让我算算", "琢磨", "🤔"}},
	{"asleep", []string{"睡着了", "睡着", "呼呼", "睡了", "已经睡", "zzz", "💤"}},
	{"tired", []string{"累了", "好累", "累死", "累瘫", "疲惫", "没力气", "精疲力尽", "🥱"}},
	{"sleepy", []string{"好困", "困了", "想睡", "晚安", "打哈欠", "犯困", "😴"}},
	...
	{"speechless", []string{"无语", "无话可说", "服了", "醉了", "一言难尽", "😑", "🙄"}},
	{"confused", []string{"奇怪", "不懂", "为什么", "怎么会", "搞不懂", "疑惑", "不明白", "啥意思"}},
	{"manic", []string{"鬼畜", "抽风", "发疯", "疯了", "整活", "沙雕", "癫", "抽了"}},
